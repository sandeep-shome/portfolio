...
export const Certificate = ({ certificate }: { certificate: Product }) => {
  ...
  return (
    <div className="py-10">
      ...
      <div className="flex lg:flex-row justify-between items-center flex-col mt-20">
        <Heading className="font-black mb-2 pb-1"> {certificate.title}</Heading>
        <div className="flex space-x-2 md:mb-1 mt-2 md:mt-0">
          {certificate.stack?.map((stack: string) => (
            <span
              key={stack}
      ...
      {certificate.linkPlaceholder && (
        ...
        >
          {certificate.linkPlaceholder || "Live"}
          <svg
